/**
	class EditorGUI_Toolbox_ArrayList_Plugin
		- class used to define a toolbox plugin for the EditorGUI
			that creates code for ArrayList objects from Java.
...
public class EditorGUI_Toolbox_ArrayList_Plugin implements EditorGUIToolBoxPlugin {
	
	private final static String LABEL = "ArrayList";
	private final static String SEMICOLON_TXT = ";";
	private final static String DECLARATION_CODE_PART_1 = "ArrayList ";
	private final static String DECLARATION_CODE_PART_2 = SEMICOLON_TXT;
	private final static String INIT_CODE = " = new ArrayList();";
...
}	/* End of EditorGUI_Toolbox_ArrayList_Plugin. */
