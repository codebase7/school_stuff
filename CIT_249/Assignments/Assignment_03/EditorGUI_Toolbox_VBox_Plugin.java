/**
	class EditorGUI_Toolbox_VBox_Plugin
		- class used to define a toolbox plugin for the EditorGUI
			that creates code for VBox objects from JavaFX.
...
public class EditorGUI_Toolbox_VBox_Plugin implements EditorGUIToolBoxPlugin {
	
	private final static String LABEL = "VBox";
	private final static String SEMICOLON_TXT = ";";
	private final static String DECLARATION_CODE_PART_1 = "VBox ";
	private final static String DECLARATION_CODE_PART_2 = SEMICOLON_TXT;
	private final static String INIT_CODE = " = new VBox();";
...
}	/* End of EditorGUI_Toolbox_VBox_Plugin. */
