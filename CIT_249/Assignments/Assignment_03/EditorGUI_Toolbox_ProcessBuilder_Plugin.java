/**
	class EditorGUI_Toolbox_ProcessBuilder_Plugin
		- class used to define a toolbox plugin for the EditorGUI
			that creates code for ProcessBuilder objects from Java.
...
public class EditorGUI_Toolbox_ProcessBuilder_Plugin implements EditorGUIToolBoxPlugin {
	
	private final static String LABEL = "ProcessBuilder";
	private final static String SEMICOLON_TXT = ";";
	private final static String DECLARATION_CODE_PART_1 = "ProcessBuilder ";
	private final static String DECLARATION_CODE_PART_2 = SEMICOLON_TXT;
	private final static String INIT_CODE = " = new ProcessBuilder();";
...
}	/* End of EditorGUI_Toolbox_ProcessBuilder_Plugin. */
