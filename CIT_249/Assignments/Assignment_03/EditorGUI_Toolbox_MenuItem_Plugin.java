/**
	class EditorGUI_Toolbox_MenuItem_Plugin
		- class used to define a toolbox plugin for the EditorGUI
			that creates code for MenuItem objects from JavaFX.
...
public class EditorGUI_Toolbox_MenuItem_Plugin implements EditorGUIToolBoxPlugin {
	
	private final static String LABEL = "MenuItem";
	private final static String SEMICOLON_TXT = ";";
	private final static String DECLARATION_CODE_PART_1 = "MenuItem ";
	private final static String DECLARATION_CODE_PART_2 = SEMICOLON_TXT;
	private final static String INIT_CODE = " = new MenuItem();";
...
}	/* End of EditorGUI_Toolbox_MenuItem_Plugin. */
