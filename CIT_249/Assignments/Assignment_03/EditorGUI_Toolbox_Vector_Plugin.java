/**
	class EditorGUI_Toolbox_Vector_Plugin
		- class used to define a toolbox plugin for the EditorGUI
			that creates code for Vector objects from Java.
...
public class EditorGUI_Toolbox_Vector_Plugin implements EditorGUIToolBoxPlugin {
	
	private final static String LABEL = "Vector";
	private final static String SEMICOLON_TXT = ";";
	private final static String DECLARATION_CODE_PART_1 = "Vector ";
	private final static String DECLARATION_CODE_PART_2 = SEMICOLON_TXT;
	private final static String INIT_CODE = " = new Vector();";
...
}	/* End of EditorGUI_Toolbox_Vector_Plugin. */
