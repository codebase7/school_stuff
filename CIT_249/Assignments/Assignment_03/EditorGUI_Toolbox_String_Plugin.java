/**
	class EditorGUI_Toolbox_String_Plugin
		- class used to define a toolbox plugin for the EditorGUI
			that creates code for String objects from Java.
...
public class EditorGUI_Toolbox_String_Plugin implements EditorGUIToolBoxPlugin {
	
	private final static String LABEL = "String";
	private final static String SEMICOLON_TXT = ";";
	private final static String DECLARATION_CODE_PART_1 = "String ";
	private final static String DECLARATION_CODE_PART_2 = SEMICOLON_TXT;
	private final static String INIT_CODE = " = new String();";
...
}	/* End of EditorGUI_Toolbox_String_Plugin. */
