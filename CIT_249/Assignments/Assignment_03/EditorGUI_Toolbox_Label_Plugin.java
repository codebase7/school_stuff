/**
	class EditorGUI_Toolbox_Label_Plugin
		- class used to define a toolbox plugin for the EditorGUI
			that creates code for Label objects from JavaFX.
...
public class EditorGUI_Toolbox_Label_Plugin implements EditorGUIToolBoxPlugin {
	
	private final static String LABEL = "Label";
	private final static String SEMICOLON_TXT = ";";
	private final static String DECLARATION_CODE_PART_1 = "Label ";
	private final static String DECLARATION_CODE_PART_2 = SEMICOLON_TXT;
	private final static String INIT_CODE = " = new Label();";
...
}	/* End of EditorGUI_Toolbox_Label_Plugin. */
