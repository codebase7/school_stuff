/**
	class EditorGUI_Toolbox_Scanner_Plugin
		- class used to define a toolbox plugin for the EditorGUI
			that creates code for Scanner objects from Java.
...
public class EditorGUI_Toolbox_Scanner_Plugin implements EditorGUIToolBoxPlugin {
	
	private final static String LABEL = "Scanner";
	private final static String SEMICOLON_TXT = ";";
	private final static String DECLARATION_CODE_PART_1 = "Scanner ";
	private final static String DECLARATION_CODE_PART_2 = SEMICOLON_TXT;
	private final static String INIT_CODE = " = new Scanner();";
...
}	/* End of EditorGUI_Toolbox_Scanner_Plugin. */
