/**
	class EditorGUI_Toolbox_FileChooser_Plugin
		- class used to define a toolbox plugin for the EditorGUI
			that creates code for FileChooser objects from JavaFX.
...
public class EditorGUI_Toolbox_FileChooser_Plugin implements EditorGUIToolBoxPlugin {
	
	private final static String LABEL = "FileChooser";
	private final static String SEMICOLON_TXT = ";";
	private final static String DECLARATION_CODE_PART_1 = "FileChooser ";
	private final static String DECLARATION_CODE_PART_2 = SEMICOLON_TXT;
	private final static String INIT_CODE = " = new FileChooser();";
...
}	/* End of EditorGUI_Toolbox_FileChooser_Plugin. */
