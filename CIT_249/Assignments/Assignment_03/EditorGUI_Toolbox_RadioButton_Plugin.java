/**
	class EditorGUI_Toolbox_RadioButton_Plugin
		- class used to define a toolbox plugin for the EditorGUI
			that creates code for RadioButton objects from JavaFX.
...
public class EditorGUI_Toolbox_RadioButton_Plugin implements EditorGUIToolBoxPlugin {
	
	private final static String LABEL = "RadioButton";
	private final static String SEMICOLON_TXT = ";";
	private final static String DECLARATION_CODE_PART_1 = "RadioButton ";
	private final static String DECLARATION_CODE_PART_2 = SEMICOLON_TXT;
	private final static String INIT_CODE = " = new RadioButton();";
...
}	/* End of EditorGUI_Toolbox_RadioButton_Plugin. */
