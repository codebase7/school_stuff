/**
	class EditorGUI_Toolbox_TextField_Plugin
		- class used to define a toolbox plugin for the EditorGUI
			that creates code for TextField objects from JavaFX.
...
public class EditorGUI_Toolbox_TextField_Plugin implements EditorGUIToolBoxPlugin {
	
	private final static String LABEL = "TextField";
	private final static String SEMICOLON_TXT = ";";
	private final static String DECLARATION_CODE_PART_1 = "TextField ";
	private final static String DECLARATION_CODE_PART_2 = SEMICOLON_TXT;
	private final static String INIT_CODE = " = new TextField();";
...
}	/* End of EditorGUI_Toolbox_TextField_Plugin. */
