/**
	class EditorGUI_Toolbox_ScrollPane_Plugin
		- class used to define a toolbox plugin for the EditorGUI
			that creates code for ScrollPane objects from JavaFX.
...
public class EditorGUI_Toolbox_ScrollPane_Plugin implements EditorGUIToolBoxPlugin {
	
	private final static String LABEL = "ScrollPane";
	private final static String SEMICOLON_TXT = ";";
	private final static String DECLARATION_CODE_PART_1 = "ScrollPane ";
	private final static String DECLARATION_CODE_PART_2 = SEMICOLON_TXT;
	private final static String INIT_CODE = " = new ScrollPane();";
...
}	/* End of EditorGUI_Toolbox_ScrollPane_Plugin. */
