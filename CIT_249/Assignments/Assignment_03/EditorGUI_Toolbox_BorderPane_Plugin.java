/**
	class EditorGUI_Toolbox_BorderPane_Plugin
		- class used to define a toolbox plugin for the EditorGUI
			that creates code for BorderPane objects from JavaFX.
...
public class EditorGUI_Toolbox_BorderPane_Plugin implements EditorGUIToolBoxPlugin {
	
	private final static String LABEL = "BorderPane";
	private final static String SEMICOLON_TXT = ";";
	private final static String DECLARATION_CODE_PART_1 = "BorderPane ";
	private final static String DECLARATION_CODE_PART_2 = SEMICOLON_TXT;
	private final static String INIT_CODE = " = new BorderPane();";
...
}	/* End of EditorGUI_Toolbox_BorderPane_Plugin. */
