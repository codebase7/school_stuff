/**
	class EditorGUI_Toolbox_HBox_Plugin
		- class used to define a toolbox plugin for the EditorGUI
			that creates code for HBox objects from JavaFX.
...
public class EditorGUI_Toolbox_HBox_Plugin implements EditorGUIToolBoxPlugin {
	
	private final static String LABEL = "HBox";
	private final static String SEMICOLON_TXT = ";";
	private final static String DECLARATION_CODE_PART_1 = "HBox ";
	private final static String DECLARATION_CODE_PART_2 = SEMICOLON_TXT;
	private final static String INIT_CODE = " = new HBox();";
...
}	/* End of EditorGUI_Toolbox_HBox_Plugin. */
