/**
	class EditorGUI_Toolbox_CheckBox_Plugin
		- class used to define a toolbox plugin for the EditorGUI
			that creates code for CheckBox objects from JavaFX.
...
public class EditorGUI_Toolbox_CheckBox_Plugin implements EditorGUIToolBoxPlugin {
	
	private final static String LABEL = "CheckBox";
	private final static String SEMICOLON_TXT = ";";
	private final static String DECLARATION_CODE_PART_1 = "CheckBox ";
	private final static String DECLARATION_CODE_PART_2 = SEMICOLON_TXT;
	private final static String INIT_CODE = " = new CheckBox();";
...
}	/* End of EditorGUI_Toolbox_CheckBox_Plugin. */
