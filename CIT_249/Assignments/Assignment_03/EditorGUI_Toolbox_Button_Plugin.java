/**
	class EditorGUI_Toolbox_Button_Plugin
		- class used to define a toolbox plugin for the EditorGUI
			that creates code for Button objects from JavaFX.
...
public class EditorGUI_Toolbox_Button_Plugin implements EditorGUIToolBoxPlugin {
	
	private final static String LABEL = "Button";
	private final static String SEMICOLON_TXT = ";";
	private final static String DECLARATION_CODE_PART_1 = "Button ";
	private final static String DECLARATION_CODE_PART_2 = SEMICOLON_TXT;
	private final static String INIT_CODE = " = new Button();";
...
}	/* End of EditorGUI_Toolbox_Button_Plugin. */
