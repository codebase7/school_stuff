/**
	class EditorGUI_Toolbox_SplitPane_Plugin
		- class used to define a toolbox plugin for the EditorGUI
			that creates code for SplitPane objects from JavaFX.
...
public class EditorGUI_Toolbox_SplitPane_Plugin implements EditorGUIToolBoxPlugin {
	
	private final static String LABEL = "SplitPane";
	private final static String SEMICOLON_TXT = ";";
	private final static String DECLARATION_CODE_PART_1 = "SplitPane ";
	private final static String DECLARATION_CODE_PART_2 = SEMICOLON_TXT;
	private final static String INIT_CODE = " = new SplitPane();";
...
}	/* End of EditorGUI_Toolbox_SplitPane_Plugin. */
