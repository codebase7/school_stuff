/**
	class EditorGUI_Toolbox_Tab_Plugin
		- class used to define a toolbox plugin for the EditorGUI
			that creates code for Tab objects from JavaFX.
...
public class EditorGUI_Toolbox_Tab_Plugin implements EditorGUIToolBoxPlugin {
	
	private final static String LABEL = "Tab";
	private final static String SEMICOLON_TXT = ";";
	private final static String DECLARATION_CODE_PART_1 = "Tab ";
	private final static String DECLARATION_CODE_PART_2 = SEMICOLON_TXT;
	private final static String INIT_CODE = " = new Tab();";
...
}	/* End of EditorGUI_Toolbox_Tab_Plugin. */
