/**
	class EditorGUI_Toolbox_MenuBar_Plugin
		- class used to define a toolbox plugin for the EditorGUI
			that creates code for MenuBar objects from JavaFX.
...
public class EditorGUI_Toolbox_MenuBar_Plugin implements EditorGUIToolBoxPlugin {
	
	private final static String LABEL = "MenuBar";
	private final static String SEMICOLON_TXT = ";";
	private final static String DECLARATION_CODE_PART_1 = "MenuBar ";
	private final static String DECLARATION_CODE_PART_2 = SEMICOLON_TXT;
	private final static String INIT_CODE = " = new MenuBar();";
...
}	/* End of EditorGUI_Toolbox_MenuBar_Plugin. */
