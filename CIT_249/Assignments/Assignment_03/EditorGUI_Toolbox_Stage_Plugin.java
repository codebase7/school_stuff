/**
	class EditorGUI_Toolbox_Stage_Plugin
		- class used to define a toolbox plugin for the EditorGUI
			that creates code for Stage objects from JavaFX.
...
public class EditorGUI_Toolbox_Stage_Plugin implements EditorGUIToolBoxPlugin {
	
	private final static String LABEL = "Stage";
	private final static String SEMICOLON_TXT = ";";
	private final static String DECLARATION_CODE_PART_1 = "Stage ";
	private final static String DECLARATION_CODE_PART_2 = SEMICOLON_TXT;
	private final static String INIT_CODE = " = new Stage();";
...
}	/* End of EditorGUI_Toolbox_Stage_Plugin. */
