/**
	class EditorGUI_Toolbox_ToggleGroup_Plugin
		- class used to define a toolbox plugin for the EditorGUI
			that creates code for ToggleGroup objects from JavaFX.
...
public class EditorGUI_Toolbox_ToggleGroup_Plugin implements EditorGUIToolBoxPlugin {
	
	private final static String LABEL = "ToggleGroup";
	private final static String SEMICOLON_TXT = ";";
	private final static String DECLARATION_CODE_PART_1 = "ToggleGroup ";
	private final static String DECLARATION_CODE_PART_2 = SEMICOLON_TXT;
	private final static String INIT_CODE = " = new ToggleGroup();";
...
}	/* End of EditorGUI_Toolbox_ToggleGroup_Plugin. */
