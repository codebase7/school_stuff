/**
	class EditorGUI_Toolbox_GridPane_Plugin
		- class used to define a toolbox plugin for the EditorGUI
			that creates code for GridPane objects from JavaFX.
...
public class EditorGUI_Toolbox_GridPane_Plugin implements EditorGUIToolBoxPlugin {
	
	private final static String LABEL = "GridPane";
	private final static String SEMICOLON_TXT = ";";
	private final static String DECLARATION_CODE_PART_1 = "GridPane ";
	private final static String DECLARATION_CODE_PART_2 = SEMICOLON_TXT;
	private final static String INIT_CODE = " = new GridPane();";
...
}	/* End of EditorGUI_Toolbox_GridPane_Plugin. */
