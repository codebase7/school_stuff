/**
	class EditorGUI_Toolbox_File_Plugin
		- class used to define a toolbox plugin for the EditorGUI
			that creates code for File objects from Java.
...
public class EditorGUI_Toolbox_File_Plugin implements EditorGUIToolBoxPlugin {
	
	private final static String LABEL = "File";
	private final static String SEMICOLON_TXT = ";";
	private final static String DECLARATION_CODE_PART_1 = "File ";
	private final static String DECLARATION_CODE_PART_2 = SEMICOLON_TXT;
	private final static String INIT_CODE = " = new File();";
...
}	/* End of EditorGUI_Toolbox_File_Plugin. */
