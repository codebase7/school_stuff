/**
	class EditorGUI_Toolbox_Scene_Plugin
		- class used to define a toolbox plugin for the EditorGUI
			that creates code for Scene objects from JavaFX.
...
public class EditorGUI_Toolbox_Scene_Plugin implements EditorGUIToolBoxPlugin {
	
	private final static String LABEL = "Scene";
	private final static String SEMICOLON_TXT = ";";
	private final static String DECLARATION_CODE_PART_1 = "Scene ";
	private final static String DECLARATION_CODE_PART_2 = SEMICOLON_TXT;
	private final static String INIT_CODE = " = new Scene();";
...
}	/* End of EditorGUI_Toolbox_Scene_Plugin. */
