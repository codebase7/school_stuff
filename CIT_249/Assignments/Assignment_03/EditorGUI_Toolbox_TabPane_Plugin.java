/**
	class EditorGUI_Toolbox_TabPane_Plugin
		- class used to define a toolbox plugin for the EditorGUI
			that creates code for TabPane objects from JavaFX.
...
public class EditorGUI_Toolbox_TabPane_Plugin implements EditorGUIToolBoxPlugin {
	
	private final static String LABEL = "TabPane";
	private final static String SEMICOLON_TXT = ";";
	private final static String DECLARATION_CODE_PART_1 = "TabPane ";
	private final static String DECLARATION_CODE_PART_2 = SEMICOLON_TXT;
	private final static String INIT_CODE = " = new TabPane();";
...
}	/* End of EditorGUI_Toolbox_TabPane_Plugin. */
