/**
	class EditorGUI_Toolbox_Menu_Plugin
		- class used to define a toolbox plugin for the EditorGUI
			that creates code for Menu objects from JavaFX.
...
public class EditorGUI_Toolbox_Menu_Plugin implements EditorGUIToolBoxPlugin {
	
	private final static String LABEL = "Menu";
	private final static String SEMICOLON_TXT = ";";
	private final static String DECLARATION_CODE_PART_1 = "Menu ";
	private final static String DECLARATION_CODE_PART_2 = SEMICOLON_TXT;
	private final static String INIT_CODE = " = new Menu();";
...
}	/* End of EditorGUI_Toolbox_Menu_Plugin. */
