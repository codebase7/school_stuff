/**
	class EditorGUI_Toolbox_TextArea_Plugin
		- class used to define a toolbox plugin for the EditorGUI
			that creates code for TextArea objects from JavaFX.
...
public class EditorGUI_Toolbox_TextArea_Plugin implements EditorGUIToolBoxPlugin {
	
	private final static String LABEL = "TextArea";
	private final static String SEMICOLON_TXT = ";";
	private final static String DECLARATION_CODE_PART_1 = "TextArea ";
	private final static String DECLARATION_CODE_PART_2 = SEMICOLON_TXT;
	private final static String INIT_CODE = " = new TextArea();";
...
}	/* End of EditorGUI_Toolbox_TextArea_Plugin. */
